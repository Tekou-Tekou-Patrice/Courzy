...
class RegisterEnseignant extends StatefulWidget {
  final void Function()? onTap;
  const RegisterEnseignant({super.key,required this.onTap});

  @override
  State<RegisterEnseignant> createState() => _RegisterEnseignantState();
}

class _RegisterEnseignantState extends State<RegisterEnseignant> {
  ...
  Future<void> addChef() async {
    final url = Uri.parse('http://localhost:8084/addenseignant');
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                      Text('Seule le chef de departement dois ajouter un enseignant'),
                      ],
                    ),
                     SizedBox(height: 8),
                    SizedBox(
